...
const translations: Translations = {
  ...
  lockedButton: { en: 'LOCKED - SCORE 90% ON PREVIOUS LEVEL', ru: 'ЗАБЛОКИРОВАНО - НАБЕРИТЕ 90% НА ПРЕДЫДУЩЕМ УРО��НЕ', uz: 'BLOKLANGAN - OLDINGI DARAJADA 90% BALL TO\'PLAN' },
  ...
  driverRespBullet1: { en: 'Log in to the ELD each day', ru: 'Входите �� ELD каждый ��ень', uz: 'Har kuni ELD-ga kiring' },
          ...
          >
            ...
            <div className="bg-slate-100 rounded-[40px] overflow-hidden shadow-2xl min-h-[400px] flex items-center justify-center border border-white/20">
              <img 
                ...
                alt="Professional logistics truck on highway at night with city skyline" 
